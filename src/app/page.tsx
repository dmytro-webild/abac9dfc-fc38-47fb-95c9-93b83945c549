...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/beautiful-spacious-office-dentist_8353-9976.jpg",          alt: "Beautiful spacious office of a dentist"},
        {
          src: "http://img.b2bpic.net/free-photo/high-angle-woman-laying-bed_23-2149341424.jpg",          alt: "High angle woman laying on bed"},
        {
          src: "http://img.b2bpic.net/free-photo/woman-with-doctor-cosmetology-studio_1157-33838.jpg",          alt: "Woman with a doctor in cosmetology studio"},
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/front-view-smiley-bride-before-wedding_23-2149860779.jpg",          alt: "Front view smiley bride before wedding"},
      ]}
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "We believe aesthetic beauty is a journey, not just a service. Our team combines artistry with medical precision to deliver transformative results.",        "Every procedure is performed in a relaxing, hygienic environment using state-of-the-art technology."]}
    />
  </div>
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Dermal Fillers",          description: "Enhance your natural features with expert contouring.",          imageSrc: "http://img.b2bpic.net/free-photo/beautician-doing-injection-filler-female-client_23-2148875443.jpg",          imageAlt: "beauty treatment facial filler"},
        {
          title: "HydraFacial",          description: "Deep cleanse and hydrate for a luminous glow.",          imageSrc: "http://img.b2bpic.net/free-photo/woman-cosmetology-studio-procedures_1157-34011.jpg",          imageAlt: "hydrafacial treatment process"},
        {
          title: "Laser Resurfacing",          description: "Professional laser therapy to smooth skin texture.",          imageSrc: "http://img.b2bpic.net/free-photo/female-patient-getting-rf-lifting-procedure_107420-74030.jpg",          imageAlt: "laser skin resurfacing treatment"},
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",          title: "Is there any downtime?",          content: "Most treatments require minimal to no downtime."},
        {
          id: "q2",          title: "Are consultations free?",          content: "Initial consultations are included in all treatment bookings."},
        {
          id: "q3",          title: "Who performs the treatments?",          content: "All procedures are performed by our licensed medical aesthetic experts."},
      ]}
